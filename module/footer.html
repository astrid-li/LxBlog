...
<footer class="site-footer" id="siteFooter">
    ...
    <div class="inner">
        ...
        <div class="site-info">
            ...
            <!-- 请尊重作者，请务必保留版权 -->
            <p>技术：<a target="_blank" href="http://halo.run">Halo</a> •
                主题： <a target="_blank" href="https://github.com/GalaxySuze/gridea-theme-subtle-galaxy">Subtle
                    Galaxy</a> •
                 修改基础来源于：<a href="https://github.com/hshanx/halo-theme-hshan.git">寒山</a>• 在此基础之上本人根据自身爱好添加了其他的功能及设置</p>
                 
            <a href="https://github.com/astrid-li/LxBlog.git">本人博客主题下载</a>
